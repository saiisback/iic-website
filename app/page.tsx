  ...
  return (
    <section className="relative min-h-[100dvh] w-full overflow-hidden bg-black">
      ...
      <div className="absolute right-5 top-5 z-10 flex flex-col items-end text-sm font-medium tracking-[0.3em] text-white md:right-16 md:top-12 md:text-base">
        ...
        <Link
          href="/dashboard"
          className="mt-2 inline-flex bg-white px-4 py-2 text-sm font-medium tracking-[0.3em] text-black transition-transform duration-200 hover:-translate-y-px focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:translate-y-px"
        >
          LOCK IN
        </Link>
        <HomeNavigation />
